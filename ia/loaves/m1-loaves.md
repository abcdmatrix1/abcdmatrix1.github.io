...
## 구약 외경
- 요세푸스 등 인용할 때, 영향을 받았다고 표현하지 말고, 같은 문화권 안에서 형성되었다 라는 식으로 서술해야 한다.
- 모음집. 탈무드 이전에 나온 것
- 야훼 신앙 정당성, 신학과 하는 과정에서 나오는 여러 가지 비역사적인 표현들 (하가르가 파라오의 딸이다 등)
- 유다 고대사
	- 구약 인물에 대해 재해석한 내용들이 다수 발견된다
- 라바 (모음집)
	- 어쨌든 구약 정경이 계시 진리, 완성된 것임을 전제하고 여러 가지 덧붙인거라고 보면 된다.
	- 강조점이 역사가 아니라 의미에 두고 있는 것. 강조를 어디에 두었느냐 놓치지 말아야 한다.
- 왜 이렇게 읽을까. 무엇을 강조하려고? (과학질문이 아님. 방향 다르다). 그것을 서사적으로? 풀어낸 것이 문학일까? (나의 의문)

## 신약 정경
- 공통 환경을 공통 분모로 갖고 있다 정도로만 서술해야 한다.
- 영향 받았다고 하려면 증명해야 함.
...
## conflict in mark
- 군중
	- 기적과 악마의 외침은 독자에게 도움을 준다. 저자 마르코는 예수=그리스도=구원 사명, 목적 정체성 모두 알고 있고, 중간 중간 악마의 외침과 기적 이야기는 그것을 드러내고 있다.
	- 그런데 군중과 제자들은 계속 모른다.
	- 이 효과.

## 헹엘
- 바오로와 마르코를 신학적으로 연결(종속)시키면 곤란한다
- 마르코는 그리스어를 할 줄 아는 유다인
	- 아람어도 할 줄 아는데 (어휘)
	- 이렇게 그리스어 유다인 아람어 다 들어간 저작을 헹엘은 적어도 마르코 복음 말고는 없다.
	- p45, 46
----

## 
필론에서 자주 쓰인 eulogeo
연속성 동사의 의미가 찬양, 좋게 말하다.
예수가 eulogeo라고 했다는 맥락은 구약 LXX에서 쓰인 동사 의미가 신약에서도 연결된 것으로 보아야
theios aner 논쟁은 kelley 논문에서.
...
## 0719
로마 문명 어휘로 쓰였다. 당시 시대상을 반영한 것. 역사적 해석 비평의 출발점으로 삼을 필요성이 있음을 확인한다. 왜 이러한 표현들이 쓰였는가? 시대상을 왜 반영했을까? 당시 상황을 묘사하고, 예수의 면모와 기적을 묘사하는 데에 그만큼 의미를 전달하기 용이하고 독자에게 전달력을 확보할 수 있었기 때문이 아닐까?

제자들에게 나누어 주라고 시킨 부분은 열왕기 하권과 동일한 구조로 기적 이야기를 바라보게 한다. 왜 비슷하게 서술하고 있는가? 그리고 열왕기와 마르코 복음의 서술에서 제자가 차이가 있는가? 사도들의 위치는 분명 구약과 비교했을 때 신약의 복음서에서 독특한 위치를 차지한다. 마르코 복음 안에서는 

3,14 doubtful (복수 대격, 명명하다)
6,7 몇몇 사본은 다른 텍스트 (preferred, inf 쓰임)

본고에서는 본문 비평에 따라 제자와 사도에 관한 어휘가 어느 사본에 사용되어 본문의 의미가 달라지는 양상에 대해서는 깊게 다루지 않기로 한다. 다만 일반적으로 받아들여진 본문에 사용된 '파견하다' 동사가 사용된 